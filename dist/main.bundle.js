...
var AppComponent = (function () {
    function AppComponent(service, fb) {
        ...
        this.complexForm = fb.group({
            ...
            'city': [null, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* Validators */].required])]
        });
...
var AppService = (function () {
    ...
    AppService.prototype.send = function (sender, subject, name, city) {
        var body = this.templates[this.currentPos].content.replace("[CITY]", city).replace("[NAME]", name);
